...
<head>
    ...
    <title>Lssg绿色蔬果商城|支付页面</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<%= basePath %>/statics/prefix/assets/img/images/lssg.ico">
        ...
        <div class="container payment-con">
            <form  target="_blank" action="#" id="pay-form" method="post">
                <div class="order-info">
                    <div class="msg">
                        <h5>您的订单已提交成功！请尽快在<span class="container timeBar ys2" id="dTime" data="" ></span>内付款，否则订单会被自动取消</h5>
                        <p></p>
                    ...
                    <div class="icon-box">
                        <i class="iconfont"><img src="<%= basePath %>/statics/prefix/assets/img/images/yes_ok.png"></i>
                    </div>
                </div>
